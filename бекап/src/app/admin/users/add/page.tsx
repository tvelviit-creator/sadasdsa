      ...
      <div className="w-full max-w-[375px] relative min-h-screen bg-[var(--bg-color)] flex flex-col">
        ...
        <header className="fixed top-0 left-1/2 -translate-x-1/2 w-full max-w-[375px] h-[102px] z-[100]">
          <svg width="375" height="102" viewBox="0 0 375 102" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
            ...
            <path d="M375 102V101H0V102V103H375V102Z" fill="var(--border-color)" mask="url(#path-1-inside-1_1706_5018_add)"/>
        ...
        <main className="flex-1 pt-[118px] px-6 pb-20 space-y-8">
          ...
          <div className="space-y-5">
             <div className="space-y-2">
                ...
                <div className="w-full h-[60px] bg-[var(--card-bg)] rounded-[20px] flex items-center px-5">
                  <input 
                    ...
                    className="w-full bg-transparent border-none outline-none text-[16px] font-bold text-[var(--text-primary)] placeholder-[var(--text-primary)]/20"
             ...
             <div className="space-y-2">
                ...
                <div className="w-full h-[60px] bg-[var(--card-bg)] rounded-[20px] flex items-center px-5">
                  <input 
                    ...
                    className="w-full bg-transparent border-none outline-none text-[16px] font-bold text-[var(--text-primary)] placeholder-[var(--text-primary)]/20 tabular-nums"
                    style={{ fontFamily: 'var(--font-cera)' }}
             ...
             <div className="space-y-2">
               ...
               <div className="bg-[var(--card-bg)] rounded-[20px] p-5 flex items-center justify-between active:scale-[0.98] transition-all cursor-pointer" onClick={() => setIsPartner(!isPartner)}>
                  ...
                  <div 
                    className={`w-[58px] h-[32px] rounded-full relative transition-all duration-500 overflow-hidden border ${isPartner ? 'bg-white border-white' : 'bg-[var(--bg-color)] border-[var(--border-color)]'}`}
                  >
                     <div 
                       className={`absolute top-1/2 -translate-y-1/2 w-6 h-6 rounded-full transition-all duration-500 ease-[cubic-bezier(0.68,-0.55,0.27,1.55)] ${isPartner ? 'right-1 bg-[var(--bg-color)] shadow-lg' : 'left-1 bg-[var(--border-color)]'}`}
                     />
                  </div>
               </div>
             </div>
          ...
          <div className="w-full pt-4">
            <button 
              onClick={handleSave}
              className="w-full h-[56px] bg-[var(--border-color)] text-[var(--text-primary)] rounded-full text-[16px] font-bold tracking-wider border border-[var(--border-color)] shadow-xl active:scale-95 transition-all"
