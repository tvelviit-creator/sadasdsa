...
export default function BottomNav() {
    ...
    } else if (pathname.includes("/setting-new") || pathname.includes("/tema")) {
        activeX = 243.25;
        activeTab = 'settings';
    }
        ...
        <div className={`fixed bottom-10 left-1/2 -translate-x-1/2 w-[327px] h-[64px] z-50 transition-all duration-600 ease-[cubic-bezier(0.16,1,0.3,1)] ${isHidden ? 'translate-y-[150%] opacity-0 scale-95' : 'translate-y-0 opacity-100 scale-100'}`}>
            <svg width="327" height="64" viewBox="0 0 327 64" fill="none" xmlns="http://www.w3.org/2000/svg" className="absolute top-0 left-0 pointer-events-none drop-shadow-xl transition-all duration-300">
                ...
                <g stroke="var(--text-primary)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    <path d="M36.0272 35.2344C35.875 35.6019 35.875 36.0679 35.875 36.9997C35.875 37.9316 35.875 38.3981 36.0272 38.7656C36.2302 39.2557 36.6193 39.6447 37.1094 39.8477C37.4769 39.9999 37.9429 39.9999 38.8747 39.9999C39.8066 39.9999 40.2731 39.9999 40.6406 39.8477C41.1307 39.6447 41.5197 39.2554 41.7227 38.7654C41.8749 38.3978 41.8749 37.9319 41.8749 37C41.8749 36.0681 41.8749 35.6019 41.7227 35.2344C41.5197 34.7443 41.1307 34.3552 40.6406 34.1522C40.2731 34 39.8066 34 38.8747 34C37.9429 34 37.4769 34 37.1094 34.1522C36.6193 34.3552 36.2302 34.7443 36.0272 35.2344Z" />
                    <path d="M46.0272 25.2344C45.875 25.6019 45.875 26.0679 45.875 26.9997C45.875 27.9316 45.875 28.3981 46.0272 28.7656C46.2302 29.2557 46.6193 29.6447 47.1094 29.8477C47.4769 29.9999 47.9429 29.9999 48.8747 29.9999C49.8066 29.9999 50.2731 29.9999 50.6406 29.8477C51.1307 29.6447 51.5197 29.2554 51.7227 28.7654C51.8749 28.3978 51.8749 27.9319 51.8749 27C51.8749 26.0681 51.8749 25.6019 51.7227 25.2344C51.5197 24.7443 51.1307 24.3552 50.6406 24.1522C50.2731 24 49.8066 24 48.8747 24C47.9429 24 47.4769 24 47.1094 24.1522C46.6193 24.3552 46.2302 24.7443 46.0272 25.2344Z" />
                    <path d="M36.0272 25.2344C35.875 25.6019 35.875 26.0679 35.875 26.9997C35.875 27.9316 35.875 28.3981 36.0272 28.7656C36.2302 29.2557 36.6193 29.6447 37.1094 29.8477C37.4769 29.9999 37.9429 29.9999 38.8747 29.9999C39.8066 29.9999 40.2731 29.9999 40.6406 29.8477C41.1307 29.6447 41.5197 29.2554 41.7227 28.7654C41.8749 28.3978 41.8749 27.9319 41.8749 27C41.8749 26.0681 41.8749 25.6019 41.7227 25.2344C41.5197 24.7443 41.1307 24.3552 40.6406 24.1522C40.2731 24 39.8066 24 38.8747 24C37.9429 24 37.4769 24 37.1094 24.1522C36.6193 24.3552 36.2302 24.7443 36.0272 25.2344Z" />
                    <path d="M46.0273 35.2345C45.8751 35.602 45.8751 36.068 45.8751 36.9999C45.8751 37.9317 45.8751 38.3982 46.0273 38.7657C46.2303 39.2558 46.6194 39.6448 47.1095 39.8478C47.477 40 47.943 40 48.8748 40C49.8067 40 50.2732 40 50.6407 39.8478C51.1308 39.6448 51.5198 39.2555 51.7228 38.7655C51.875 38.3979 51.875 37.932 51.875 37.0001C51.875 36.0682 51.875 35.602 51.7228 35.2345C51.5198 34.7444 51.1308 34.3554 50.6407 34.1524C50.2732 34.0001 49.8067 34.0001 48.8748 34.0001C47.943 34.0001 47.477 34.0001 47.1095 34.1524C46.6194 34.3554 46.2303 34.7444 46.0273 35.2345Z" />
                </g>
