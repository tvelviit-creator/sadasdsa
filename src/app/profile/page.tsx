  ...
  return (
    <div className="min-h-screen bg-[var(--bg-color)] text-[var(--text-primary)] pb-10 font-sans overflow-x-hidden transition-colors duration-300">
      ...
      <div className="hidden lg:flex flex-col w-full max-w-[1400px] mx-auto px-12 pt-16 pb-32 min-h-screen gap-10">
          <div className="flex justify-between items-end w-full mb-4">
              <div className="flex flex-col">
                  <button onClick={() => router.push("/client")} className="group flex items-center gap-3 text-[var(--text-secondary)] hover:text-[var(--accent-cyan)] transition-colors duration-300 mb-8 w-fit">
                      ...
                      <span className="text-[13px] font-black uppercase tracking-[0.2em] mt-0.5">В КАТАЛОГ</span>
                  </button>
                  ...
                  <div className="w-full bg-[var(--nav-bg)]/30 border border-[var(--border-color)] rounded-[32px] p-8 flex flex-col gap-6 relative overflow-hidden focus-within:border-[var(--text-primary)]/50 transition-colors group">
                      ...
                      <div className="space-y-4 relative z-10 w-full">
                          <div className="space-y-2">
                              <label className="text-[10px] font-black uppercase tracking-[0.1em] text-[var(--text-secondary)] ml-2 transition-colors group-focus-within:text-[var(--text-primary)]">ИМЯ ОБРАЩЕНИЯ</label>
                          ...
                          <div className="space-y-2">
                              <label className="text-[10px] font-black uppercase tracking-[0.1em] text-[var(--text-secondary)] ml-2 transition-colors group-focus-within:text-[var(--text-primary)]">ЭЛЕКТРОННАЯ ПОЧТА</label>
      ...
      <div className="lg:hidden w-full flex-1 relative min-h-screen bg-transparent">
        ...
        {/* Figma SVG Header for Client Profile (Mobile & Tablet) */}
          ...
          <div className="flex flex-col md:flex-row gap-8 items-start mb-12">
            ...
            <div className="flex flex-col items-center md:items-start w-full md:w-[320px] shrink-0 gap-6">
              <div className="flex flex-col items-center w-full">
                ...
                className="w-full min-h-[160px] rounded-[24px] border border-dashed border-[var(--border-color)] flex flex-col items-center justify-center gap-2 cursor-pointer active:bg-[var(--text-primary)]/5 transition-all bg-[var(--nav-bg)]/30 backdrop-blur-md p-6 group hover:border-[var(--accent-cyan)] shadow-xl relative overflow-hidden"
              >
            ...
            <div className="flex-1 w-full space-y-8">
              <div className="space-y-6">
                <div className="space-y-2">
                  <label className="text-[var(--text-secondary)] text-[10px] font-black uppercase tracking-[0.2em] ml-4 transition-colors">ИМЯ ОБРАЩЕНИЯ</label>
                  <input
                    value={name}
                ...
                <div className="space-y-2">
                  <label className="text-[var(--text-secondary)] text-[10px] font-black uppercase tracking-[0.2em] ml-4 transition-colors">ЭЛЕКТРОННАЯ ПОЧТА</label>
                  <input
                    value={email}
